...
export const SceneView = forwardRef<ArcgisSceneView, PropsWithChildren>(
  function SceneView(props, ref) {
    const [view] = useState(
      () =>
        new ArcgisSceneView({
          popupEnabled: false,
...
function SceneViewProvider({
  view,
  children,
}: PropsWithChildren<{ view: ArcgisSceneView }>) {
  return (
